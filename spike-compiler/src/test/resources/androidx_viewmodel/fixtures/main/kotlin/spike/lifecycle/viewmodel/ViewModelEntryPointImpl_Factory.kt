...
public class ViewModelEntryPointImpl_Factory(
    public val handle: SavedStateHandle,
) : DependencyFactory() {
    override val maxConstructorArgs: Int = 1

    private val holder0: ViewModelEntryPointImpl_DependencyHolder0 =
        ViewModelEntryPointImpl_DependencyHolder0(this)

    override val instructionSet: IntArray
        get() = ViewModelEntryPointImpl_InstructionSet.memory
